...
class PedidoPaymentFailUseCaseImplTest {

    @Mock
    private RepositoryGateway repository;

    @InjectMocks
    private PedidoPaymentFailUseCaseImpl pedidoPaymentFailUseCase;
    ...
    void testChangeToClosedPaymentFail() {
        ...
        pedidoPaymentFailUseCase.changeToClosedPaymentFail(pedidoId);
    ...
    @Test
    void testChangeToClosedPaymentFailPedidoNotFound() {
        String pedidoId = "pedido123";

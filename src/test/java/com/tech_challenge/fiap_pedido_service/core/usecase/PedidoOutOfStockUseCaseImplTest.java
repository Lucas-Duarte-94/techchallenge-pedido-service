...
class PedidoOutOfStockUseCaseImplTest {

    @Mock
    private RepositoryGateway repository;

    @InjectMocks
    private PedidoOutOfStockUseCaseImpl pedidoOutOfStockUseCase;
    ...
    void testChangeToClosedOutOfStock() {
        ...
        pedidoOutOfStockUseCase.changeToClosedOutOfStock(pedidoId);
    ...
    @Test
    void testChangeToClosedOutOfStockPedidoNotFound() {
        String pedidoId = "pedido123";
